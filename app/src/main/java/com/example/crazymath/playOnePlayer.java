...
public class playOnePlayer extends Activity {
   ...
   public void RandomQuestion()
    ...
    void Anhxa()
    {
        a= findViewById(R.id.answerplayera);
        b= findViewById(R.id.answerplayerb);
        c= findViewById(R.id.answerplayerc);
        d= findViewById(R.id.answerplayerd);
        it=getIntent() ;
        seekBar= findViewById(R.id.seekbar);
        txt= findViewById(R.id.txt);
        score= findViewById(R.id.sorce);
