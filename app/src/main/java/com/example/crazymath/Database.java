...
public class Database extends SQLiteOpenHelper{
    ...
    {
        Database database = new Database(context,"Crazymath.sqlite",null,1);
        database.QueryData("CREATE TABLE IF NOT EXISTS users(id VARCHAR PRIMARY KEY,username varchar, password varchar, email varchar)");
        database.close();
